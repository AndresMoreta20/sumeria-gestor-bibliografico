...
const saveAuthor = async () => {
  if (!form.value.name.trim()) {
    errorMessage.value = 'El nombre del autor no puede estar vacío'
    return
  }
    ...
    <SectionMain>
      ...
      <CardBox form>
        <FormField label="Nombre">
          <FormControl v-model="form.name" placeholder="Ingrese el nombre del autor" required :disabled="isLoading" />
        </FormField>
